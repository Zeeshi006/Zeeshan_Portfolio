...
2. **About / Story** — short narrative: EE → self-taught backend → architecture & applied AI. Human, not a wall of text. **[API]**
...
Note: the portfolio *itself* becomes an implicit 4th case study via the "How This Site Is Built" section.
